  ...
  return (
    <div className="flex justify-between items-center h-16 px-8 m-auto text-white bg-zinc-900 ">
        ...
        <div className="flex flex-row gap-8 mr-8">
            <div className="flex rounded-md transition-all ease duration-200 cursor-pointer h-12 w-32 items-center justify-center bg-blue-600 text-white text-lg hover:bg-blue-700">
              Register
            </div>
            <div className="flex rounded-md transition-all ease duration-200 cursor-pointer h-12 w-28 items-center justify-center hover:bg-slate-800 hover:text-white">
              Log In 
            </div>
        </div>
    </div>  
